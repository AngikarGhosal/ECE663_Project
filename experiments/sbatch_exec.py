...
parser.add_argument('-t', type=str, help='time requested', default="90:00:00")
...
parser.add_argument('-x', type=str, help='Pre-set configurations', default="train-s")
parser.add_argument('--nooutput', action='store_true', help='Output the command and settings')
parser.add_argument('--exclude', type=str, help='exclude some nodes', default=""""gpu-compute[1-3], linux[41-44]" """)
parser.add_argument('--specialinfo', type=str, help='special info for the log name', default='')
...
sh_tmp = "./{}.sh".format(os.getcwd().split('/')[-1])
